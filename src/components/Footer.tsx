...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="relative scroll-mt-28 overflow-hidden border-t border-white/5 bg-transparent px-6 pb-12 pt-20 md:px-20 md:pt-24"
    >
      <div className="pointer-events-none absolute left-1/2 top-0 -z-10 h-[400px] w-[800px] -translate-x-1/2 rounded-[100%] bg-[var(--color-accent)]/5 blur-[100px]" />

      <div className="mx-auto flex max-w-7xl flex-col items-center text-center md:items-start md:text-left">
        <motion.p
          {...fadeUp}
          className="mb-6 flex items-center gap-2 font-mono text-sm uppercase tracking-widest text-[var(--color-accent)]"
        >
        ...
        >
          Let&apos;s create <br />
          <span className="italic text-white/60">magic.</span>
        </motion.h2>

        <p className="mb-4 text-sm text-white/72">
          Tell me your goals, timeline, and scope — I usually reply within 24 hours.
        </p>
