...
function getAdditionalShowcaseProjects(): readonly ShowcaseProject[] {
  ...
  {
    id: 37,
    title: "New Day Organics Serum Commercial",
    category: "Cinematic",
    gradient: "from-amber-500/20 via-zinc-950/40 to-transparent",
    accent: "#F59E0B",
    tags: ["AI Video", "Product Commercial"],
    summary: "AI generated skincare commercial built from prompt-driven product shots.",
    outcome: "Delivered a full serum ad cut without a physical product shoot.",
    type: "video",
    aiGenerated: true,
    videoSrc: "/works/ai-videos/skincare-commercial-edit.mp4",
    bentoSize: "medium",
    brief: "Generate a premium serum commercial with macro texture and clean studio light.",
    deliverables: ["Prompt direction", "Shot generation", "Edit and grade"],
    impact: "Showed how AI generation can stand in for a full studio product shoot.",
    role: "AI video direction, editing",
    mediaAlt: "AI generated New Day Organics facial serum commercial frame",
    visualTreatment: {
      code: "AIV-01",
      signal: "AI Product Film",
      texture: "studio macro",
  ...
  {
    id: 38,
    title: "Serum Glow Finale Cut",
    category: "Cinematic",
    gradient: "from-yellow-500/20 via-zinc-950/40 to-transparent",
    accent: "#FBBF24",
    tags: ["AI Video", "Motion Design"],
    summary: "AI generated hero finale with floating oil droplets and glow lighting.",
    outcome: "Closed the campaign with a high-shine hero reveal frame.",
    type: "video",
    aiGenerated: true,
    videoSrc: "/works/ai-videos/skincare-commercial-finale.mp4",
    bentoSize: "medium",
    brief: "Land the campaign on a luminous hero shot of the serum bottle.",
    deliverables: ["Hero shot generation", "Droplet motion", "Final grade"],
    impact: "Gave the campaign a repeatable end card for social placements.",
    role: "AI video direction, editing",
    mediaAlt: "AI generated serum bottle glow finale frame",
    visualTreatment: {
      code: "AIV-02",
      signal: "AI Hero Reveal",
      texture: "golden glow",
      tint: "rgba(251, 191, 36, 0.26)",
      frame: "AI",
    },
  },
  {
    id: 39,
    title: "Magnetic Tool Mat UGC Ad",
    category: "Cinematic",
    gradient: "from-red-500/20 via-zinc-950/40 to-transparent",
    accent: "#F87171",
    tags: ["AI Video", "UGC Ad"],
    summary: "AI generated UGC style ad film with a garage host and caption pacing.",
    outcome: "Produced a talking-head product ad with no on-camera talent.",
    type: "video",
    aiGenerated: true,
    videoSrc: "/works/ai-videos/ai-product-film.mp4",
    bentoSize: "medium",
    brief: "Build a believable creator-style ad for a magnetic tool mat.",
    deliverables: ["Script and prompts", "Scene generation", "Caption edit"],
    impact: "Covered a full UGC ad format entirely through AI generation.",
    role: "AI video direction, editing",
    mediaAlt: "AI generated magnetic tool mat UGC ad frame",
    visualTreatment: {
      code: "AIV-03",
      signal: "AI UGC Ad",
      texture: "garage grain",
      tint: "rgba(248, 113, 113, 0.26)",
      frame: "AI",
    },
  },
  ];
